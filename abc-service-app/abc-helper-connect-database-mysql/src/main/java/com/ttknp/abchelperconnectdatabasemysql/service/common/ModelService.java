...
public abstract class ModelService<T> implements RowMapper<T> {
    ...
    private final String sqlScriptDirOnAbs = AbsolutePathUtility.SQL_SCRIPT_DIR_ON_PARENT;
    ...
    public void loadScriptAbsPath( String fileName, JdbcTemplate jdbcTemplateSQL, HashMap<String,String> params) throws  IOException {
        log.info("fullSqlScriptDirOnRoot {}" , fileName);
        String fullSqlScriptDirOnRoot = sqlScriptDirOnAbs + fileName;
    ...
    // ** It's working but on Jar file not!
